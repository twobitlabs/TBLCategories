...
@objc public extension UIView {
    @discardableResult func addConstraintsFromDescriptions(_ constraintDescriptions: [String], views: Dictionary<String, UIView>) -> [NSLayoutConstraint] {
        return addConstraintsFromDescriptions(constraintDescriptions, views: views, metrics: nil)
    }

    @objc @discardableResult func addConstraintsFromDescriptions(_ constraintDescriptions: [String], metrics: Dictionary<String, NSNumber>? = nil, views: Dictionary<String, UIView>) -> [NSLayoutConstraint] {
        return addConstraintsFromDescriptions(constraintDescriptions, views: views, metrics: metrics)
    }

    @discardableResult func objc_pinToTop(identifier: String? = nil) -> NSLayoutConstraint {
        return pinToTop(priority: nil, identifier: identifier)
    }

    @discardableResult func objc_pinToBottom(identifier: String? = nil) -> NSLayoutConstraint {
        return pinToBottom(priority: nil, identifier: identifier)
    }

    @discardableResult func objc_pinToLeft(identifier: String? = nil) -> NSLayoutConstraint {
        return pinToLeft(priority: nil, identifier: identifier)
    }

    @discardableResult func objc_pinToRight(identifier: String? = nil) -> NSLayoutConstraint {
        return pinToRight(priority: nil, identifier: identifier)
    }

    @discardableResult func objc_insetFromParentLeft(_ inset: CGFloat, identifier: String? = nil) -> NSLayoutConstraint {
        return insetFromParentLeft(inset, priority: nil, identifier: identifier)
    }

    @discardableResult func objc_insetFromParentRight(_ inset: CGFloat, identifier: String? = nil) -> NSLayoutConstraint {
        return insetFromParentRight(inset, priority: nil, identifier: identifier)
    }

    @discardableResult func objc_insetFromParentTop(_ inset: CGFloat, identifier: String? = nil) -> NSLayoutConstraint {
    ...
    @discardableResult func objc_insetFromParentBottomByAtLeast(_ inset: CGFloat, identifier: String? = nil) -> NSLayoutConstraint {
        return insetFromParentBottomByAtLeast(inset, priority: nil, identifier: identifier)
    }

    @discardableResult func objc_fillParentVertically(identifier: String? = nil) -> [NSLayoutConstraint] {
        return fillParentVertically(priority: nil, identifier: identifier)
    }

    @discardableResult func objc_fillParentHorizontally(identifier: String? = nil) -> [NSLayoutConstraint] {
        return fillParentHorizontally(priority: nil, identifier: identifier)
    }

    @discardableResult func objc_centerChildHorizontally(_ childView: UIView, identifier: String? = nil) -> NSLayoutConstraint {
        return centerChildHorizontally(childView, priority: nil, identifier: identifier)
    }

    @discardableResult func objc_centerChildVertically(_ childView: UIView, identifier: String? = nil) -> NSLayoutConstraint {
        return centerChildVertically(childView, priority: nil, identifier: identifier)
    }

    @discardableResult func objc_setHeightConstraint(_ size: CGFloat, identifier: String? = nil) -> NSLayoutConstraint {
        return setHeightConstraint(size, priority: nil, identifier: identifier)
    }

    @discardableResult func objc_setWidthConstraint(_ size: CGFloat, identifier: String? = nil) -> NSLayoutConstraint {
